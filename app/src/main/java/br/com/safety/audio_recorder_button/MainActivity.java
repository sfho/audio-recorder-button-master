...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        this.mAudioRecordButton.setOnAudioListener(new AudioListener() {
            ...
            public void onStop(RecordingItem recordingItem) {
                Toast.makeText(getBaseContext(), "Save Audio..\n" + getSharedPreferences("audio",
                        Context.MODE_PRIVATE).getString("audio",""), Toast.LENGTH_LONG).show();
    ...
    private void initView() {
        this.mAudioRecordButton = findViewById(R.id.audio_record_button);
    }
